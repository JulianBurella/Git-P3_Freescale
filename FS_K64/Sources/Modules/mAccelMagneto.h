...
------------------------------------------------------------
File name :				mAD5933.h
Author and date :	serge.monnerat, 28.2.2014

Goal :  FXOS8700CQ accéléromètre et magnétomètre
...
#define kFXOS8700CQAddr 0x1D	// Read:0x1E, Write:0x1D
...
// Structure de lecture des accélérations brutes
typedef struct
{
	float x;
	float y;
